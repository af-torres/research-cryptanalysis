...
ECN_FILE_NAME = "encryptedEngSeq.csv"
...
def read_english_sentences():
    ENG_SEQ_FILE = "./data/eng_sentences/englishSentences.csv"
    with open(ENG_SEQ_FILE, "r") as file:
...
if __name__ == "__main__":
    ...
    decrypted_data = read_english_sentences()
